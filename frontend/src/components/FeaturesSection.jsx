...
const features = [
  ...
  },
  {
    ...
    description: "Uncover hidden trends with a comprehensive dashboard that provides clear visual analytics on comment engagement and topics.",
    "color": "from-sky-500 to-cyan-500",
  },
  {
    icon: <FaFileExport />,
    title: "Flexible Data Export",
    description: "Take your data anywhere. Easily export search results or integrate our API for seamless use in your own applications.",
